...
namespace CanadaPostApi.Client
{
    ...
    public class Configuration
    {
        ...
        public Configuration(ApiClient apiClient = null,
                             ...
                             int timeout = 1000,
                             string userAgent = "Canada Post SDK; .netCore6.0"
                            )
        {
        ...
        public static readonly ExceptionFactory DefaultExceptionFactory = (methodName, response) =>
        {
            ...
            if (status >= 400) return new ApiException(status, String.Format("Error calling {0}: {1}", methodName, response.StatusCode), response.StatusDescription);
            if (status == 0) return new ApiException(status, String.Format("Error calling {0}: {1}", methodName, response.StatusCode), response.StatusDescription);
            return null;
        };
        ...
        /// <summary>
        /// Gets or sets the HTTP accept language
        /// </summary>
        /// <value>Http user agent.</value>
        ...
        {
            String report = "C# SDK (CanadaPostApi) Debug Report:\n";
